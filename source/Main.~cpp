...
{
// R 50 02: Resetea
  //usb.EnviarDatos(rst_micro,0x50,0x02);
//  usb.PP2ResetMicro();
  ...
  // c 50 03: Habilita modo carga
  //usb.EnviarDatos(mod_carga,0x50,0x03);
//  usb.PP2ModoCarga();
...
void __fastcall TMainForm::TsClick(TObject *Sender)
{
 unsigned int delta_t;
  byte rm; int ret=0; double muestras;
...
void __fastcall TMainForm::ADQUIRIRClick(TObject *Sender)
{
 TADModoAdquisicion mAdq;
  ...
  do
  {
        ...
        usb.direccion(0x0b);
        usb.EnviarDatos_Respuesta();
        if ( usb.RxBuffer[1] & 0x01 )  //  primer byte es el comando segundo es el valor leido de respuesta OK-S-
                                //   la deberia perderse.
        {
...
void __fastcall TMainForm::ADSetConfig(int modoAdq, int k, int reset, int modo)
{
  ...
  usb.SetComando('r');
  usb.direccion(0x0b);
//  escritura (config);	  // Modo microprocesador
...
void __fastcall TMainForm::LeerUnCanal( int direccion, char * puntero )
{
    ...
    switch (CmbBarrido->ItemIndex)
    {
        ...
        break;
        case 1:
            cantidad_bytes = 2*1024;
        break;
        case 2:
            cantidad_bytes = 4*1024;
        break;
        case 3:
            cantidad_bytes = 8*1024;
        break;
        case 4:
            cantidad_bytes = 16*1024;
        break;
        case 5:
            cantidad_bytes = 32*1024;
        break;
        case 6:
            cantidad_bytes = 64*1024;
        break;
        case 7:
            cantidad_bytes = 128*1024;
        break;
...
{
 if ((atoi(TxtMax->Text.c_str()) < 128*1024)& ( atoi(TxtMax->Text.c_str()) < atoi(CmbBarrido->Text.c_str())*1024 ))
    {
        TxtMin->Text = atoi(TxtMin->Text.c_str()) + 1024;
        TxtMax->Text = atoi(TxtMax->Text.c_str()) + 1024;
        dibuja();
...
void __fastcall TMainForm::FTW1Click(TObject *Sender)
{
 ...
 // cargar un registro 04 del DDS2 con w1_5
 // k 75 04 78 w1_5
  usb.SetComando('k');
 ...
 // cargar un registro 05 del DDS2 con w1_4
 // k 75 05 78 w1_4
  usb.SetComando('k');
 ...
 // cargar un registro 06 del DDS2 con w1_3
 // k 75 06 78 w1_3
  usb.SetComando('k');
 ...
 // cargar un registro 07 del DDS2 con w1_2
 // k 75 07 78 w1_2
  usb.SetComando('k');
  ...
  // cargar un registro 08 del DDS2 con w1_1
 // k 75 08 78 w1_1
  usb.SetComando('k');
 ...
 // cargar un registro 09 del DDS2 con w1_0
 // k 75 09 78 w1_0
  usb.SetComando('k');
